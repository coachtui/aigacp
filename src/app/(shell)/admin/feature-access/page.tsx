            ...
            <Card key={mod.id} variant={enabled ? "default" : "default"} className={!enabled ? "opacity-60" : ""}>
              <div className="flex items-center justify-between mb-4">
                ...
                {enabled ? (
                  ...
                  <span className="flex items-center gap-1 text-[10px] font-semibold uppercase tracking-widest text-content-secondary bg-surface-border border border-surface-border-hover px-2 py-0.5 rounded-[var(--radius-badge)]">
                    <Lock size={9} /> Locked
                  </span>
                )}
              </div>
