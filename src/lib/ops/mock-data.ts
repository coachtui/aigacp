import type { WorkOrder, Request, PourEvent } from "./types";
...
export const MOCK_POUR_EVENTS: PourEvent[] = [
  {
    id:           "pour_001",
    jobsite:      "Highland Tower — Phase 2",
    date:         "2026-04-12",
    yardage:      220,
    pumpRequired: true,
    crewRequired: "Structural Crew T-3",
    status:       "confirmed",
  },
  {
    id:           "pour_002",
    ...
    yardage:      180,
    pumpRequired: true,
    crewRequired: "Concrete Crew R-1",
    status:       "planned",
    conflicts:    true,
  },
  {
    ...
    yardage:      95,
    pumpRequired: false,
    crewRequired: "Concrete Crew E-2",
    status:       "planned",
  },
  {
    id:           "pour_004",
